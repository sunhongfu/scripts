cd /Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2
pfilePath = '/Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/p-files/P54272.7';
outputDir = '/Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/recon';
recon_arc(pfilePath, [], outputDir);


path_mag = '/Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/recon/unaliasedImage_mag.nii';
path_pha = '/Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/recon/unaliasedImage_pha.nii';
path_dicom = '/Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/J_B/Devel_Hba_17109/BRAVO_0';
...
% read in the uncombined niftis
nii =  load_nii(path_mag);
mag_all = single(permute(nii.img,[2 1 3 4 5]));

nii =  load_nii(path_pha);
...
mag1_sos = squeeze(sqrt(sum(mag_all(:,:,:,:,1).^2,3)));
nii = make_nii(mag1_sos,vox);
save_nii(nii,'mag1_sos.nii');


% register MEGRE to MEBRAVO
!/usr/local/fsl/bin/flirt -in /Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/J_B/Devel_Hba_17109/QSM_SPGR_GE/src/mag1.nii -ref /Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/QSM_BRAVO_UNCOMBINED/mag1_sos.nii -out //Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/QSM_BRAVO_UNCOMBINED/qsm2bravo -omat /Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/QSM_BRAVO_UNCOMBINED/qsm2bravo.mat -bins 256 -cost corratio -searchrx -180 180 -searchry -180 180 -searchrz -180 180 -dof 12  -interp trilinear

!/usr/local/fsl/bin/flirt -in /Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/J_B/Devel_Hba_17109/QSM_SPGR_GE/BET_mask.nii -applyxfm -init //Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/QSM_BRAVO_UNCOMBINED/qsm2bravo.mat -out /Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/QSM_BRAVO_UNCOMBINED/BET_mask_flirt -paddingsize 0.0 -interp trilinear -ref /Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/QSM_BRAVO_UNCOMBINED/mag1_sos.nii

!gunzip /Users/uqhsun8/DATA/MEBRAVO/HONGFU_PRODUCTION_1/Subject2/QSM_BRAVO_UNCOMBINED/BET_mask_flirt.nii.gz
...
% [~,~] = unix('rm BET*');
% unix('bet2 mag1_sos.nii BET -f 0.4 -m -w 2');
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % use the last echo only
% tfs_te4 = unph(:,:,:,4)/TE(4);
% tfs_te4 = -tfs_te4/(2.675e8*dicom_info.MagneticFieldStrength)*1e6; % unit ppm
% [lfs_resharp_te4, mask_resharp_te4] = resharp(tfs_te4,mask.*R,vox,smv_rad,tik_reg,cgs_num);
% % % 3D 2nd order polyfit to remove any residual background
% % lfs_resharp_te4= lfs_resharp_te4 - poly3d(lfs_resharp_te4,mask_resharp_te4);

% % save nifti
% [~,~,~] = mkdir('RESHARP');
% nii = make_nii(lfs_resharp_te4,vox);
% save_nii(nii,['RESHARP/lfs_resharp_te4_tik_', num2str(tik_reg), '_num_', num2str(cgs_num), '.nii']);

% % % inversion of susceptibility 
% % disp('--> TV susceptibility inversion on RESHARP...');
% % sus_resharp = tvdi(lfs_resharp_te4,mask_resharp_te4,vox,tv_reg,mag(:,:,:,end),z_prjs,inv_num); 

% % % save nifti
% % nii = make_nii(sus_resharp.*mask_resharp_te4,vox);
% % save_nii(nii,['RESHARP/sus_resharp_tik_', num2str(tik_reg), '_tv_', num2str(tv_reg), '_num_', num2str(inv_num), '.nii']);

% % iLSQR
% chi_iLSQR = QSM_iLSQR(lfs_resharp_te4*(2.675e8*dicom_info.MagneticFieldStrength)/1e6,mask_resharp_te4,'H',z_prjs,'voxelsize',vox,'niter',50,'TE',1000,'B0',dicom_info.MagneticFieldStrength);
% nii = make_nii(chi_iLSQR,vox);
% save_nii(nii,['RESHARP/chi_iLSQR_smvrad' num2str(smv_rad) '_te4.nii']);
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
