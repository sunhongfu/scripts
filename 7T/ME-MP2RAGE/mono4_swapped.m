...
path_ph = '/home/hongfu/cj97_scratch/hongfu/ME-MP2RAGE/Tuccio_525/1.10.3.525/1.10.3.525.1.1/1.10.3.525.1.1.94/dicom_series'
path_mag = '/home/hongfu/cj97_scratch/hongfu/ME-MP2RAGE/Tuccio_525/1.10.3.525/1.10.3.525.1.1/1.10.3.525.1.1.95/dicom_series'
path_out = '/home/hongfu/cj97_scratch/hongfu/ME-MP2RAGE/Tuccio_525/1.10.3.525/1.10.3.525.1.1/4_mono_swapped';
...
% odd sliced to even number, e.g. 195 to 196
mag(:,:,end+1,:,:) = mag(:,:,end,:,:);
ph(:,:,end+1,:,:) = ph(:,:,end,:,:);
...
[ph_corr,mag_corr] = geme_cmb(mag.*exp(1j*ph),vox,TE,mask,'gaussian');
...
% for smv_rad = [1 2 3]
    ...
    % trim into even number
    lfs_resharp_0 = lfs_resharp_0(:,:,1:end-1);
    mask_resharp_0 = mask_resharp_0(:,:,1:end-1);
