...
% FOR bipolar QSM acquisition
clear
cd /home/hongfu/cj97_scratch/hongfu/COSMOS/01EG/1.7.72.2/1.7.72.2.1.2/BI-QSM_0p75/QSM_MEGE_7T
load('raw.mat','mag_corr','imsize','mag_list')
path_mag = '/scratch/cj97/hongfu/COSMOS/01EG/1.7.72.2/1.7.72.2.1.2/BI-QSM_0p75/1.7.72.2.1.2.31/dicom_series'
...
clear
cd /scratch/cj97/hongfu/COSMOS/02SCOTT/1.7.72.3/1.7.72.3.1.3/BI-QSM_0p75/QSM_MEGE_7T
load('raw.mat','mag_corr','imsize','mag_list')
path_mag = '/scratch/cj97/hongfu/COSMOS/02SCOTT/1.7.72.3/1.7.72.3.1.3/BI-QSM_0p75/1.7.72.3.1.3.25/dicom_series'
...
load('raw.mat','mag_corr','imsize','mag_list')
path_mag = '/home/hongfu/cj97_scratch/hongfu/COSMOS/03JK/1.7.72.5/1.7.72.5.1.3/BI-QSM_0p75/1.7.72.5.1.3.26/dicom_series'
...
clear
cd /scratch/cj97/hongfu/COSMOS/05SG/1.7.72.4/1.7.72.4.1.2/BI-QSM_0p75/QSM_MEGE_7T
load('raw.mat','mag_corr','imsize','mag_list')
path_mag = '/scratch/cj97/hongfu/COSMOS/05SG/1.7.72.4/1.7.72.4.1.2/BI-QSM_0p75/1.7.72.4.1.2.25/dicom_series'
...
load('raw.mat','mag_corr','imsize','mag_list')
path_mag = '/home/hongfu/cj97_scratch/hongfu/COSMOS/07JON/1.7.72.6/1.7.72.6.1.1/BI-QSM_0p75/1.7.72.6.1.1.59/dicom_series'
