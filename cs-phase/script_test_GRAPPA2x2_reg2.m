...
dt_fa04 = mapVBVD('/Volumes/LaCie_Top/CS-phase/invivo/2021_06_04_CS_QSM_001/RAW/meas_MID00115_FID08843_gre_full_2x2.dat', 'removeOS');
mkdir('/Volumes/LaCie_Top/CS-phase/invivo/2021_06_04_CS_QSM_001/GRAPPA2X2_reg');
cd('/Volumes/LaCie_Top/CS-phase/invivo/2021_06_04_CS_QSM_001/GRAPPA2X2_reg');
...
dat = padarray(dat, [0,0,1,0,0],'pre');
%%
num_ro = s(dat,1);
