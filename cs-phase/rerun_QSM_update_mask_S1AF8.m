...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cd('/Volumes/LaCie_Top/CS-phase/invivo/2021_06_04_CS_QSM_001/DCRNet_sim_recon_dc_AF8/new-coil')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear
cd('/Volumes/LaCie_Top/CS-phase/invivo/2021_06_04_CS_QSM_001/zf_AF8')
load('/Volumes/LaCie_Top/CS-phase/invivo/2021_06_04_CS_QSM_001/DCRNet_sim_recon_dc_AF8/new-coil/all_new.mat','mask','R');

load('/Volumes/LaCie_Top/CS-phase/invivo/2021_06_04_CS_QSM_001/zf_AF8/all.mat','tfs','vox','smv_rad','tik_reg','cgs_num','dicom_info','z_prjs');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear
cd('/Volumes/LaCie_Top/CS-phase/invivo/07_June_CSPC/AF8_001/CSPC_recon_lamda_01_015/cspc_HScoils')
load('/Volumes/LaCie_Top/CS-phase/invivo/2021_06_04_CS_QSM_001/DCRNet_sim_recon_dc_AF8/new-coil/all_new.mat','mask','R');

load('/Volumes/LaCie_Top/CS-phase/invivo/07_June_CSPC/AF8_001/CSPC_recon_lamda_01_015/cspc_HScoils/all.mat','tfs','vox','smv_rad','tik_reg','cgs_num','dicom_info','z_prjs');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear
cd('/Volumes/LaCie_Top/CS-phase/invivo/07_June_CSPC/AF8_001/CSPC_recon_lamda_003_005/cspc_HScoils')
load('/Volumes/LaCie_Top/CS-phase/invivo/2021_06_04_CS_QSM_001/DCRNet_sim_recon_dc_AF8/new-coil/all_new.mat','mask','R');

load('/Volumes/LaCie_Top/CS-phase/invivo/07_June_CSPC/AF8_001/CSPC_recon_lamda_003_005/cspc_HScoils/all.mat','tfs','vox','smv_rad','tik_reg','cgs_num','dicom_info','z_prjs');
