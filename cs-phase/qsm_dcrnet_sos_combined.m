nii = load_nii('combined_noDC_sos_mag.nii');
mag_corr = permute(double(nii.img), [3, 1, 2, 4]) ;

nii = load_nii('combined_noDC_sos_ph.nii');
ph_corr = permute(double(nii.img), [3, 1, 2, 4]) ;
