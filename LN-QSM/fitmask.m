...
tfs_pad_poly3_mask = (tfs_pad - poly3d(tfs_pad,mask_pad,3)).*mask_pad;
tfs_pad_poly2_mask = (tfs_pad - poly3d(tfs_pad,mask_pad,2)).*mask_pad;
tfs_pad_poly1_mask = (tfs_pad - poly3d(tfs_pad,mask_pad,1)).*mask_pad;

tfs_pad_poly3_soft = (tfs_pad - poly3d(tfs_pad,mask_soft_pad,3)).*mask_soft_pad;
tfs_pad_poly2_soft = (tfs_pad - poly3d(tfs_pad,mask_soft_pad,2)).*mask_soft_pad;
tfs_pad_poly1_soft = (tfs_pad - poly3d(tfs_pad,mask_soft_pad,1)).*mask_soft_pad;

tfs_pad_poly3_soft2 = (tfs_pad - poly3d(tfs_pad,mask_pad,3)).*mask_soft_pad;
tfs_pad_poly2_soft2 = (tfs_pad - poly3d(tfs_pad,mask_pad,2)).*mask_soft_pad;
tfs_pad_poly1_soft2 = (tfs_pad - poly3d(tfs_pad,mask_pad,1)).*mask_soft_pad;
