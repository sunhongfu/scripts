    ...
    with torch.no_grad():
        ...
        for orien in ['left', 'right', 'forward', 'backward', 'central', 'central_permute132', 'central_bigAngle', 'resized']:
            ...
            net.load_state_dict(torch.load(
                '/scratch/itee/uqhsun8/zhuang/unrolledQSM_WideResNet_torchParams_copy/torchParams_unrolledQSM/res.pth'),False)
            net.to(device)
            net.eval()
            ...
            name_msk = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/unrolledQSM_wideRes_proximal/renzo_' + \
                orien + '_unrolledQSM.nii'
            path = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/unrolledQSM_wideRes_proximal/renzo_' + \
