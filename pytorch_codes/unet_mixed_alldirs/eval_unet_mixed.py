    ...
    with torch.no_grad():
        ...
        for orien in ['central_bigAngle']:
            ...
            octnet.load_state_dict(torch.load(
                '/scratch/itee/uqhsun8/CommQSM/pytorch_codes/unet_mixed_alldirs/unet_mixed_alldirs.pth'))
            octnet.to(device)
            octnet.eval()
            ...
            name_msk = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/unet_mixed_alldirs/renzo_' + \
                orien + '_unet_mixed_alldirs.nii'
            path = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/unet_mixed_alldirs/renzo_' + \
