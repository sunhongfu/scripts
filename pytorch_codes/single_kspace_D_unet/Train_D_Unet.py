...
def yangSaveNet(resnet, enSave=False):
    ...
    if enSave:
        torch.save(
            resnet, '/scratch/itee/uqhsun8/CommQSM/pytorch_codes/single_kspace_D_unet/D_Unet.pth')
    else:
        torch.save(resnet.state_dict(
        ), '/scratch/itee/uqhsun8/CommQSM/pytorch_codes/single_kspace_D_unet/D_Unet_test.pth')
