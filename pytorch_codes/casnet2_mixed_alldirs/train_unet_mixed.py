...
def yangDataLoad(Batch_size):
    ...
    DATA_LIST_PATH = '/scratch/itee/uqhsun8/CommQSM/pytorch_codes/image_unet_stack_prjs_alldirs/z_prjs_alldirs.txt'
...
def yangSaveNet(resnet, enSave=False):
    ...
    if enSave:
        torch.save(
            resnet, '/scratch/itee/uqhsun8/CommQSM/pytorch_codes/casnet2_mixed_alldirs/casnet2_mixed_alldirs.pth')
    else:
