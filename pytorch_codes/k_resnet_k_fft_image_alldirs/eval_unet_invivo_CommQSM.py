...
if __name__ == '__main__':
    with torch.no_grad():
        ...
        for orien in ['left', 'right', 'forward', 'backward', 'central', 'central_permute132', 'central_bigAngle', 'resized']:
            ...
            name_msk = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/k_resnet_k_fft_image_alldirs/renzo_' + \
                orien + '_k_resnet_k_fft_image_alldirs.nii'
            path = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/k_resnet_k_fft_image_alldirs/renzo_' + \
                orien + '_k_resnet_k_fft_image_alldirs.mat'
