...
if __name__ == '__main__':
    with torch.no_grad():
        ...
        for orien in ['left', 'right', 'forward', 'backward', 'central', 'central_permute132', 'central_bigAngle']:
            ...
            name_msk = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/casnet_mixed_alldirs/renzo_' + \
                orien + '_casnet_mixed_alldirs.nii'
            path = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/casnet_mixed_alldirs/renzo_' + \
                orien + '_casnet_mixed_alldirs.mat'
