    ...
    with torch.no_grad():
        ...
        for orien in ['central_permute132']:
            ...
            octnet.load_state_dict(torch.load(
                '/scratch/itee/uqhsun8/CommQSM/pytorch_codes/image_unet_stack_D/image_unet_stack_D.pth'))
            octnet.to(device)
            octnet.eval()
            ...
            name_msk = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/image_unet_stack_D/renzo_' + \
                orien + '_image_unet_stack_D.nii'
            path = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/image_unet_stack_D/renzo_' + \
                orien + '_image_unet_stack_D.mat'
