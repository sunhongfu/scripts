...
def yangDataLoad(Batch_size):
    ...
    DATA_LIST_PATH = '/scratch/itee/uqhsun8/CommQSM/pytorch_codes/single_D_unet/test_IDs.txt'
...
def yangSaveNet(resnet, enSave=False):
    ...
    if enSave:
        torch.save(
            resnet, '/scratch/itee/uqhsun8/CommQSM/pytorch_codes/single_D_unet/D_Unet.pth')
    else:
        torch.save(resnet.state_dict(
        ), '/scratch/itee/uqhsun8/CommQSM/pytorch_codes/single_D_unet/D_Unet_test.pth')


def yangTrainNet(resnet, Dipole, LR=0.001, Batchsize=32, Epoches=100, useGPU=False):
    print('ResNet')
    print('DataLoad')
...
if __name__ == '__main__':
    ...
    nib_D = nib.load(
        '/scratch/itee/uqhsun8/CommQSM/pytorch_codes/single_D_unet/dipole.nii')
    """
    ...
    # train network
    yangTrainNet(resnet, D,  LR=0.001, Batchsize=32, Epoches=100, useGPU=True)
