...
if __name__ == '__main__':
    with torch.no_grad():
        print('kspace_unet_stack_D_shift_resnet')
        for orien in ['left', 'right', 'forward', 'backward', 'central']:
            ...
            octnet.load_state_dict(torch.load(
                '/scratch/itee/uqhsun8/CommQSM/pytorch_codes/kspace_unet_stack_D_shift_resnet/kspace_unet_stack_D_shift_resnet.pth'))
            octnet.to(device)
            octnet.eval()
            ...
            name_msk = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/kspace_unet_stack_D_shift_resnet/renzo_' + \
                orien + '_kspace_unet_stack_D_shift_resnet.nii'
            path = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/kspace_unet_stack_D_shift_resnet/renzo_' + \
                orien + '_kspace_unet_stack_D_shift_resnet.mat'
