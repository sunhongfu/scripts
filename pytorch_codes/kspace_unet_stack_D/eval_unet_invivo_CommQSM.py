...
if __name__ == '__main__':
    with torch.no_grad():
        print('kspace_unet_stack_D')
        for orien in ['left', 'right', 'forward', 'backward', 'central']:
            nibimage = nib.load(
                '/scratch/itee/uqhsun8/CommQSM/invivo/testing/renzo/renzo_' + orien + '_field_kspace_real.nii')
            ...
            nibimage = nib.load(
                '/scratch/itee/uqhsun8/CommQSM/invivo/testing/renzo/renzo_' + orien + '_field_kspace_imag.nii')
            ...
            name_msk = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/kspace_unet_stack_D/renzo_' + \
                orien + '_kspace_unet_stack_D.nii'
            path = '/scratch/itee/uqhsun8/CommQSM/invivo/testing/kspace_unet_stack_D/renzo_' + \
                orien + '_kspace_unet_stack_D.mat'
