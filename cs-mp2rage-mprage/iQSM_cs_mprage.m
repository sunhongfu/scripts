...
load '/Volumes/LaCie_Top/CSMEMP2RAGE/singleTI_05082022/Csmp2Rage_003/Research_19049_Me_Mprage - 1/pat3_eco7_TI_1300_TR_2600/QSM_R2S_PRISMA/all.mat'
nii = make_nii(ph_corr, vox);
save_nii(nii,'/Volumes/LaCie_Top/CSMEMP2RAGE/singleTI_05082022/Csmp2Rage_003/Research_19049_Me_Mprage - 1/pat3_eco7_TI_1300_TR_2600/QSM_R2S_PRISMA/src/ph_corr_all.nii')
nii = make_nii(mag, vox);
save_nii(nii,'/Volumes/LaCie_Top/CSMEMP2RAGE/singleTI_05082022/Csmp2Rage_003/Research_19049_Me_Mprage - 1/pat3_eco7_TI_1300_TR_2600/QSM_R2S_PRISMA/src/mag_all.nii')
...
PhasePath    = '/Volumes/LaCie_Top/CSMEMP2RAGE/singleTI_05082022/Csmp2Rage_003/Research_19049_Me_Mprage - 1/pat3_eco7_TI_1300_TR_2600/QSM_R2S_PRISMA/src/ph_corr_all.nii';  % where raw phase data is (in NIFTI format)
ReconDir     = '/Volumes/LaCie_Top/CSMEMP2RAGE/singleTI_05082022/Csmp2Rage_003/Research_19049_Me_Mprage - 1/pat3_eco7_TI_1300_TR_2600/QSM_R2S_PRISMA/iQSM';  %% where to save reconstruction output
...
MaskPath = '/Volumes/LaCie_Top/CSMEMP2RAGE/singleTI_05082022/Csmp2Rage_003/Research_19049_Me_Mprage - 1/pat3_eco7_TI_1300_TR_2600/QSM_R2S_PRISMA/BET_mask.nii'; %% brain mask; set to one will skip brain masking
MagPath = '/Volumes/LaCie_Top/CSMEMP2RAGE/singleTI_05082022/Csmp2Rage_003/Research_19049_Me_Mprage - 1/pat3_eco7_TI_1300_TR_2600/QSM_R2S_PRISMA/src/mag_all.nii'; % magnitude image; set to one will skip magnitude weights in echo fitting
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
