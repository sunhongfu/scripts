...
chi_ero2_masked_2000 = tikhonov_qsm(tfs_pad, Res_wt.*mask_pad, 1, mask_pad, mask_pad, 0, 5e-4, 0.001, 0, vox, 1, z_prjs, 2000);
nii = make_nii(chi_ero2_masked_2000,vox);
save_nii(nii,['chi_ero2_mm_1e-3_wt_fitmask_masked_2000_P1.nii']);

chi_ero2_masked_5000 = tikhonov_qsm(tfs_pad, Res_wt.*mask_pad, 1, mask_pad, mask_pad, 0, 5e-4, 0.001, 0, vox, 1, z_prjs, 5000);
nii = make_nii(chi_ero2_masked_5000,vox);
save_nii(nii,['chi_ero2_mm_1e-3_wt_fitmask_masked_5000_P1.nii']);
