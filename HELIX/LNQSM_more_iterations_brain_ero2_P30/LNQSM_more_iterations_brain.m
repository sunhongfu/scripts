...
nii = load_nii('mask_ero2.nii');
mask_ero2 = double(nii.img);
mask_soft_pad = padarray(mask_ero2,[0 0 40]);
mask_pad = mask_soft_pad;
...
chi_ero2_masked_2000 = tikhonov_qsm(tfs_pad, Res_wt.*mask_pad, 1, mask_pad, mask_pad, 0, 5e-4, 0.001, 0, vox, P, z_prjs, 2000);
nii = make_nii(chi_ero2_masked_2000,vox);
save_nii(nii,['chi_ero2_mm_1e-3_wt_fitmask_masked_2000_P30.nii']);

chi_ero2_masked_5000 = tikhonov_qsm(tfs_pad, Res_wt.*mask_pad, 1, mask_pad, mask_pad, 0, 5e-4, 0.001, 0, vox, P, z_prjs, 5000);
nii = make_nii(chi_ero2_masked_5000,vox);
save_nii(nii,['chi_ero2_mm_1e-3_wt_fitmask_masked_5000_P30.nii']);
