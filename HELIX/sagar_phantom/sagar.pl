...
./run_sagar_phantom_helix.sh \$MCR $Tik_weight $TV_weight> mycode_\${PBS_JOBID}.out
echo \"Job finished at: `date`\"
";
		
		# write the pbs files
		open(my $fileHandle, '>', "/home/hongfu.sun/standalone/sagar_phantom/Tik_${Tik_weight}_TV_${TV_weight}.pbs");
