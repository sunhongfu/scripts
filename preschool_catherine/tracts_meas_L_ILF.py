...
output_file_L_ILF = "/home/hongfu/mnt/deepmri/preschool/project_preschool/L_ILF.txt"
...
for root, dirs, files in os.walk(merge_folder):
    for name in files:
        if re.match(r".*l.?ilf.*\.nii", name, re.IGNORECASE):
