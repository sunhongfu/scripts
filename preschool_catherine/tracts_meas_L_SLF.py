...
output_file_L_SLF = "/home/hongfu/mnt/deepmri/preschool/project_preschool/L_SLF.txt"
...
for root, dirs, files in os.walk(merge_folder):
    for name in files:
        if re.match(r".*l.?slf.*\.nii", name, re.IGNORECASE):
