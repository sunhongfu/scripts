...
for name in glob.glob(merge_folder + "/*.nii"):
    ...
    with open(output_file, 'a') as f:
        print >> f, name
    if re.match(r".*_(\S+)_B0_n4_DC_corr\.nii", name):

        b0_file_n4 = os.path.abspath(os.path.join(merge_folder, name))
        mag_sos_n4 = os.path.abspath(os.path.join(
            merge_folder, "mag_sos_RAS_masked_n4.nii"))
        ants_trans_T2s_to_B0 = os.path.abspath(
            os.path.join(merge_folder, "ANTs_trans_T2s_to_B0"))
        ants_T2s_to_B0 = os.path.abspath(
            os.path.join(merge_folder, "ANTs_T2s_to_B0.nii.gz"))
        flirt_trans_T2s_to_B0 = os.path.abspath(
            os.path.join(merge_folder, "flirt_trans_T2s_to_B0.mat"))
        flirt_T2s_to_B0 = os.path.abspath(
            os.path.join(merge_folder, "flirt_T2s_to_B0.nii.gz"))
        qsmImage1 = os.path.abspath(os.path.join(
            merge_folder, "chi_ero0_tik_1e-3_tv_1e-4_2000_peel_1_RAS.nii"))
        qsmImage2 = os.path.abspath(os.path.join(
            merge_folder, "chi_iLSQR_peel1_RAS.nii"))
        qsmImage3 = os.path.abspath(os.path.join(
            merge_folder, "MEDI2000_LBV_peel1_RAS.nii"))
        qsmImage4 = os.path.abspath(os.path.join(
            merge_folder, "TFI_lbv_v2d_lambda2000_peel_1_RAS.nii"))
        qsmANTsOutImage1 = os.path.abspath(os.path.join(
            merge_folder, "chi_ero0_tik_1e-3_tv_1e-4_2000_peel_1_RAS_ants_to_B0.nii"))
        qsmANTsOutImage2 = os.path.abspath(os.path.join(
            merge_folder, "chi_iLSQR_peel1_RAS_ants_to_B0.nii.nii"))
        qsmANTsOutImage3 = os.path.abspath(os.path.join(
            merge_folder, "MEDI2000_LBV_peel1_RAS_ants_to_B0.nii.nii"))
        qsmANTsOutImage4 = os.path.abspath(os.path.join(
            merge_folder, "TFI_lbv_v2d_lambda2000_peel_1_RAS_ants_to_B0.nii.nii"))
        qsmFlirtOutImage1 = os.path.abspath(os.path.join(
            merge_folder, "chi_ero0_tik_1e-3_tv_1e-4_2000_peel_1_RAS_flirt_to_B0.nii"))
        qsmFlirtOutImage2 = os.path.abspath(os.path.join(
            merge_folder, "chi_iLSQR_peel1_RAS_flirt_to_B0.nii.nii"))
        qsmFlirtOutImage3 = os.path.abspath(os.path.join(
            merge_folder, "MEDI2000_LBV_peel1_RAS_flirt_to_B0.nii.nii"))
        qsmFlirtOutImage4 = os.path.abspath(os.path.join(
            merge_folder, "TFI_lbv_v2d_lambda2000_peel_1_RAS_flirt_to_B0.nii.nii"))
