...
output_file_R_ILF = "/home/hongfu/mnt/deepmri/preschool/project_preschool/R_ILF.txt"
...
for root, dirs, files in os.walk(merge_folder):
    for name in files:
        if re.match(r".*r.?ilf.*\.nii", name, re.IGNORECASE):
