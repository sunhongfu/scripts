...
output_file_R_IFO = "/home/hongfu/mnt/deepmri/preschool/project_preschool/R_IFO.txt"
...
for root, dirs, files in os.walk(merge_folder):
    for name in files:
        if re.match(r".*r.?ifo.*\.nii", name, re.IGNORECASE):
