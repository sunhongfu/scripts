...
output_file_L_IFO = "/home/hongfu/mnt/deepmri/preschool/project_preschool/L_IFO.txt"
...
for root, dirs, files in os.walk(merge_folder):
    for name in files:
        if re.match(r".*l.?ifo.*\.nii", name, re.IGNORECASE):
