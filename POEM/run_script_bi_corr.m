...
save_nii(nii,['RESHARP/corr_lfs_resharp_' num2str(tik_reg) '_' num2str(smv_rad) '.nii']);
...
save_nii(nii,['RESHARP/corr_sus_resharp_' num2str(tv_reg) '_' num2str(inv_num) '.nii']);
