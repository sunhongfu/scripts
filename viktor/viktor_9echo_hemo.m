nii1 = load_untouch_nii('/Volumes/LaCie_Bottom/collaborators/Viktor_Vegh/BBB_microbleed_QSM/BBB_015_MEGRE_QSM_s015.nii');
mag = single(nii1.img);

nii2 = load_untouch_nii('/Volumes/LaCie_Bottom/collaborators/Viktor_Vegh/BBB_microbleed_QSM/BBB_015_MEGRE_QSM_phase.nii');
pha = single(nii2.img);
...
TE = (5.84+(0:8)*4.79)/1000;


mkdir('/Volumes/LaCie_Bottom/collaborators/Viktor_Vegh/BBB_microbleed_QSM/BBB_015_MEGRE_QSM')
cd('/Volumes/LaCie_Bottom/collaborators/Viktor_Vegh/BBB_microbleed_QSM/BBB_015_MEGRE_QSM')
...
unix('bet2 mag1.nii BET -f 0.01 -m');
