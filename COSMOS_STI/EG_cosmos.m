...
!/usr/local/fsl/bin/flirt -in /Volumes/LaCie/COSMOS_7T/01EG/flexion/QSM_MEGE_7T/src/mag_corr1.nii -ref /Volumes/LaCie/COSMOS_7T/01EG/neutral/QSM_MEGE_7T/src/mag_corr1.nii -out /Volumes/LaCie/COSMOS_7T/01EG/flexion/flirt_mag_12DOF.nii.gz -omat /Volumes/LaCie/COSMOS_7T/01EG/flexion/flirt_mag_12DOF.mat -bins 256 -cost normcorr -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -dof 12  -interp trilinear

!/usr/local/fsl/bin/flirt -in /Volumes/LaCie/COSMOS_7T/01EG/extension/QSM_MEGE_7T/src/mag_corr1.nii -ref /Volumes/LaCie/COSMOS_7T/01EG/neutral/QSM_MEGE_7T/src/mag_corr1.nii -out /Volumes/LaCie/COSMOS_7T/01EG/extension/flirt_mag_12DOF.nii.gz -omat /Volumes/LaCie/COSMOS_7T/01EG/extension/flirt_mag_12DOF.mat -bins 256 -cost normcorr -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -dof 12  -interp trilinear

!/usr/local/fsl/bin/flirt -in /Volumes/LaCie/COSMOS_7T/01EG/right/QSM_MEGE_7T/src/mag_corr1.nii -ref /Volumes/LaCie/COSMOS_7T/01EG/neutral/QSM_MEGE_7T/src/mag_corr1.nii -out /Volumes/LaCie/COSMOS_7T/01EG/right/flirt_mag_12DOF.nii.gz -omat /Volumes/LaCie/COSMOS_7T/01EG/right/flirt_mag_12DOF.mat -bins 256 -cost normcorr -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -dof 12  -interp trilinear

!/usr/local/fsl/bin/flirt -in /Volumes/LaCie/COSMOS_7T/01EG/left/QSM_MEGE_7T/src/mag_corr1.nii -ref /Volumes/LaCie/COSMOS_7T/01EG/neutral/QSM_MEGE_7T/src/mag_corr1.nii -out /Volumes/LaCie/COSMOS_7T/01EG/left/flirt_mag_12DOF.nii.gz -omat /Volumes/LaCie/COSMOS_7T/01EG/left/flirt_mag_12DOF.mat -bins 256 -cost normcorr -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -dof 12  -interp trilinear



% apply the transformation to local field map (smvrad2)
!/usr/local/fsl/bin/flirt -in /Volumes/LaCie/COSMOS_7T/01EG/flexion/QSM_MEGE_7T/RESHARP/lfs_resharp_0_smvrad2_cgs_1e-06.nii -applyxfm -init /Volumes/LaCie/COSMOS_7T/01EG/flexion/flirt_mag_12DOF.mat -out /Volumes/LaCie/COSMOS_7T/01EG/flexion/flirt_lfs_smvrad2.nii -paddingsize 0.0 -interp trilinear -ref /Volumes/LaCie/COSMOS_7T/01EG/neutral/QSM_MEGE_7T/RESHARP/lfs_resharp_0_smvrad2_cgs_1e-06.nii

!/usr/local/fsl/bin/flirt -in /Volumes/LaCie/COSMOS_7T/01EG/extension/QSM_MEGE_7T/RESHARP/lfs_resharp_0_smvrad2_cgs_1e-06.nii -applyxfm -init /Volumes/LaCie/COSMOS_7T/01EG/extension/flirt_mag_12DOF.mat -out /Volumes/LaCie/COSMOS_7T/01EG/extension/flirt_lfs_smvrad2.nii -paddingsize 0.0 -interp trilinear -ref /Volumes/LaCie/COSMOS_7T/01EG/neutral/QSM_MEGE_7T/RESHARP/lfs_resharp_0_smvrad2_cgs_1e-06.nii

!/usr/local/fsl/bin/flirt -in /Volumes/LaCie/COSMOS_7T/01EG/right/QSM_MEGE_7T/RESHARP/lfs_resharp_0_smvrad2_cgs_1e-06.nii -applyxfm -init /Volumes/LaCie/COSMOS_7T/01EG/right/flirt_mag_12DOF.mat -out /Volumes/LaCie/COSMOS_7T/01EG/right/flirt_lfs_smvrad2.nii -paddingsize 0.0 -interp trilinear -ref /Volumes/LaCie/COSMOS_7T/01EG/neutral/QSM_MEGE_7T/RESHARP/lfs_resharp_0_smvrad2_cgs_1e-06.nii

!/usr/local/fsl/bin/flirt -in /Volumes/LaCie/COSMOS_7T/01EG/left/QSM_MEGE_7T/RESHARP/lfs_resharp_0_smvrad2_cgs_1e-06.nii -applyxfm -init /Volumes/LaCie/COSMOS_7T/01EG/left/flirt_mag_12DOF.mat -out /Volumes/LaCie/COSMOS_7T/01EG/left/flirt_lfs_smvrad2.nii -paddingsize 0.0 -interp trilinear -ref /Volumes/LaCie/COSMOS_7T/01EG/neutral/QSM_MEGE_7T/RESHARP/lfs_resharp_0_smvrad2_cgs_1e-06.nii
...
% define common space coordinates as the nature position orientation
% register all other orientations with the common space coordinate
!/usr/local/fsl/bin/flirt -in /Volumes/LaCie/COSMOS_7T/01EG/flexion/QSM_MEGE_7T/src/mag_corr1.nii -ref /Volumes/LaCie/COSMOS_7T/01EG/neutral/QSM_MEGE_7T/src/mag_corr1.nii -out /Volumes/LaCie/COSMOS_7T/01EG/flexion/flirt_mag_6DOF.nii.gz -omat /Volumes/LaCie/COSMOS_7T/01EG/flexion/flirt_mag_6DOF.mat -bins 256 -cost normcorr -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -dof 6  -interp trilinear

!/usr/local/fsl/bin/flirt -in /Volumes/LaCie/COSMOS_7T/01EG/extension/QSM_MEGE_7T/src/mag_corr1.nii -ref /Volumes/LaCie/COSMOS_7T/01EG/neutral/QSM_MEGE_7T/src/mag_corr1.nii -out /Volumes/LaCie/COSMOS_7T/01EG/extension/flirt_mag_6DOF.nii.gz -omat /Volumes/LaCie/COSMOS_7T/01EG/extension/flirt_mag_6DOF.mat -bins 256 -cost normcorr -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -dof 6  -interp trilinear

!/usr/local/fsl/bin/flirt -in /Volumes/LaCie/COSMOS_7T/01EG/right/QSM_MEGE_7T/src/mag_corr1.nii -ref /Volumes/LaCie/COSMOS_7T/01EG/neutral/QSM_MEGE_7T/src/mag_corr1.nii -out /Volumes/LaCie/COSMOS_7T/01EG/right/flirt_mag_6DOF.nii.gz -omat /Volumes/LaCie/COSMOS_7T/01EG/right/flirt_mag_6DOF.mat -bins 256 -cost normcorr -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -dof 6  -interp trilinear

!/usr/local/fsl/bin/flirt -in /Volumes/LaCie/COSMOS_7T/01EG/left/QSM_MEGE_7T/src/mag_corr1.nii -ref /Volumes/LaCie/COSMOS_7T/01EG/neutral/QSM_MEGE_7T/src/mag_corr1.nii -out /Volumes/LaCie/COSMOS_7T/01EG/left/flirt_mag_6DOF.nii.gz -omat /Volumes/LaCie/COSMOS_7T/01EG/left/flirt_mag_6DOF.mat -bins 256 -cost normcorr -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -dof 6  -interp trilinear
...
load /Volumes/LaCie/COSMOS_7T/01EG/flexion/flirt_mag_6DOF.mat -ASCII
R_t(:,:,1) = flirt_mag_6DOF(1:3,1:3);

load /Volumes/LaCie/COSMOS_7T/01EG/extension/flirt_mag_6DOF.mat -ASCII
R_t(:,:,2) = flirt_mag_6DOF(1:3,1:3);

load /Volumes/LaCie/COSMOS_7T/01EG/right/flirt_mag_6DOF.mat -ASCII
R_t(:,:,3) = flirt_mag_6DOF(1:3,1:3);

load /Volumes/LaCie/COSMOS_7T/01EG/left/flirt_mag_6DOF.mat -ASCII
