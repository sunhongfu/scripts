...
save_nii(nii,'/Volumes/LaCie/COSMOS_7T/07JON/flexion/flirt_lfs_smvrad2_1mm.nii');
...
im2 = imresize3(double(nii.img), newSize);
nii = make_nii(im2,vox);
save_nii(nii,'/Volumes/LaCie/COSMOS_7T/07JON/extension/flirt_lfs_smvrad2_1mm.nii');
...
im2 = imresize3(double(nii.img), newSize);
nii = make_nii(im2,vox);
save_nii(nii,'/Volumes/LaCie/COSMOS_7T/07JON/left/flirt_lfs_smvrad2_1mm.nii');
...
im2 = imresize3(double(nii.img), newSize);
nii = make_nii(im2,vox);
save_nii(nii,'/Volumes/LaCie/COSMOS_7T/07JON/right/flirt_lfs_smvrad2_1mm.nii');
...
im2 = imresize3(double(nii.img), newSize);
nii = make_nii(im2,vox);
save_nii(nii,'/Volumes/LaCie/COSMOS_7T/07JON/neutral/QSM_MEGE_7T/RESHARP/lfs_resharp_0_smvrad2_cgs_1e-06_1mm.nii');
%%%%%%%%%%%%%%%%%%
...
unix('gunzip -f /Volumes/LaCie/COSMOS_7T/07JON/flexion/*.gz');
% nii = load_nii('/Volumes/LaCie/COSMOS_7T/07JON/flexion/flirt_lfs_smvrad2.nii');
nii = load_nii('/Volumes/LaCie/COSMOS_7T/07JON/flexion/flirt_lfs_smvrad2_1mm.nii');
lfs(:,:,:,1) = double(nii.img);

unix('gunzip -f /Volumes/LaCie/COSMOS_7T/07JON/extension/*.gz');
% nii = load_nii('/Volumes/LaCie/COSMOS_7T/07JON/extension/flirt_lfs_smvrad2.nii');
nii = load_nii('/Volumes/LaCie/COSMOS_7T/07JON/extension/flirt_lfs_smvrad2_1mm.nii');
lfs(:,:,:,2) = double(nii.img);

unix('gunzip -f /Volumes/LaCie/COSMOS_7T/07JON/right/*.gz');
% nii = load_nii('/Volumes/LaCie/COSMOS_7T/07JON/right/flirt_lfs_smvrad2.nii');
nii = load_nii('/Volumes/LaCie/COSMOS_7T/07JON/right/flirt_lfs_smvrad2_1mm.nii');
lfs(:,:,:,3) = double(nii.img);

unix('gunzip -f /Volumes/LaCie/COSMOS_7T/07JON/left/*.gz');
% nii = load_nii('/Volumes/LaCie/COSMOS_7T/07JON/left/flirt_lfs_smvrad2.nii');
nii = load_nii('/Volumes/LaCie/COSMOS_7T/07JON/left/flirt_lfs_smvrad2_1mm.nii');
lfs(:,:,:,4) = double(nii.img);

% nii = load_nii('/Volumes/LaCie/COSMOS_7T/07JON/neutral/QSM_MEGE_7T/RESHARP/lfs_resharp_0_smvrad2_cgs_1e-06.nii');
nii = load_nii('/Volumes/LaCie/COSMOS_7T/07JON/neutral/QSM_MEGE_7T/RESHARP/lfs_resharp_0_smvrad2_cgs_1e-06_1mm.nii');
...
save_nii(nii,'/Volumes/LaCie/COSMOS_7T/07JON/cosmos_5_12DOF_cgs_smvrad2_1mm.nii');
