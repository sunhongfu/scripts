...
% re-run RESHARP for each orientation with parameter 1e-6
cd /home/hongfu/Desktop/9175/QSM_SPGRE_LEFT/QSM_SPGR_GE
load all.mat
[lfs_resharp, mask_resharp] = resharp(tfs,mask.*R,vox,3,1e-6,cgs_num);
...
cd /home/hongfu/Desktop/9175/QSM_SPGRE_RIGHT/QSM_SPGR_GE
load all.mat
[lfs_resharp, mask_resharp] = resharp(tfs,mask.*R,vox,3,1e-6,cgs_num);
    % % 3D 2nd order polyfit to remove any residual background
    % lfs_resharp= lfs_resharp - poly3d(lfs_resharp,mask_resharp);
...
cd /home/hongfu/Desktop/9175/QSM_SPGRE_FORWARD/QSM_SPGR_GE
load all.mat
[lfs_resharp, mask_resharp] = resharp(tfs,mask.*R,vox,3,1e-6,cgs_num);
    % % 3D 2nd order polyfit to remove any residual background
    % lfs_resharp= lfs_resharp - poly3d(lfs_resharp,mask_resharp);
...
cd /home/hongfu/Desktop/9175/QSM_SPGRE_BACKWARD/QSM_SPGR_GE
load all.mat
[lfs_resharp, mask_resharp] = resharp(tfs,mask.*R,vox,3,1e-6,cgs_num);
    % % 3D 2nd order polyfit to remove any residual background
    % lfs_resharp= lfs_resharp - poly3d(lfs_resharp,mask_resharp);
...
cd /home/hongfu/Desktop/9175/QSM_SPGRE_CENTER/QSM_SPGR_GE
load all.mat
[lfs_resharp, mask_resharp] = resharp(tfs,mask.*R,vox,3,1e-6,cgs_num);
    % % 3D 2nd order polyfit to remove any residual background
    % lfs_resharp= lfs_resharp - poly3d(lfs_resharp,mask_resharp);
...
load /home/hongfu/Desktop/9175/QSM_SPGRE_LEFT/mag_flirt.mat -ASCII
R_t(:,:,1) = mag_flirt(1:3,1:3);
load /home/hongfu/Desktop/9175/QSM_SPGRE_RIGHT/mag_flirt.mat -ASCII
R_t(:,:,2) = mag_flirt(1:3,1:3);
load /home/hongfu/Desktop/9175/QSM_SPGRE_FORWARD/mag_flirt.mat -ASCII
R_t(:,:,3) = mag_flirt(1:3,1:3);
load /home/hongfu/Desktop/9175/QSM_SPGRE_BACKWARD/mag_flirt.mat -ASCII
R_t(:,:,4) = mag_flirt(1:3,1:3);
R_t(:,:,5) = eye(3);

% (each orientation has own R and z_prjs)
% R is the rotation matrix from image space to common space
load /home/hongfu/Desktop/9175/QSM_SPGRE_LEFT/QSM_SPGR_GE/z_prjs.mat
z_prjs_o(:,1) = z_prjs';
load /home/hongfu/Desktop/9175/QSM_SPGRE_RIGHT/QSM_SPGR_GE/z_prjs.mat
z_prjs_o(:,2) = z_prjs';
load /home/hongfu/Desktop/9175/QSM_SPGRE_FORWARD/QSM_SPGR_GE/z_prjs.mat
z_prjs_o(:,3) = z_prjs';
load /home/hongfu/Desktop/9175/QSM_SPGRE_BACKWARD/QSM_SPGR_GE/z_prjs.mat
z_prjs_o(:,4) = z_prjs';
load /home/hongfu/Desktop/9175/QSM_SPGRE_CENTER/QSM_SPGR_GE/z_prjs.mat
z_prjs_o(:,5) = z_prjs';
...
save_nii(nii,'cosmos_5_resharp1e-6.nii');
