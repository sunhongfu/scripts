load('/Users/uqhsun8/Downloads/tozhifeng/20210422_invivo/gre/img_com_6echo_Buda_csm.mat');
...
imsize = size(mag);
vox = [1.1 1.1 1];
TE = [6, 18, 30, 43.17, 55, 68.34]*1e-3;
z_prjs = [0 0 1];
...
QSM = iQSM_plus(ph_corr, TE, 'mag', mag, 'mask', mask, 'voxel_size', vox, 'B0', B0, 'B0_dir', z_prjs, 'eroded_rad', 3, 'output_dir', pwd);
...
tfs = tfs/(2.675e8*MagneticFieldStrength)*1e6; % unit ppm
