% load('/Volumes/LaCie_Bottom/collaborators/Zhifeng_Chen/img_buda.mat')



load('/Volumes/LaCie_Bottom/collaborators/Zhifeng_Chen/Recon_Results_7T_TR50ms_TE25ms/img_buda_7T.mat','img_buda')
load('/Volumes/LaCie_Bottom/collaborators/Zhifeng_Chen/Recon_Results_7T_TR50ms_TE25ms/img_hybrid_sense_7T.mat','img_hybrid_sense')
load('/Volumes/LaCie_Bottom/collaborators/Zhifeng_Chen/Recon_Results_7T_TR50ms_TE25ms/img_pocs_7T.mat','img_pocs')


% % BUDA 1 RECON

% mag = squeeze(abs(img_buda(:,:,1,:)));
% ph = angle(squeeze((img_buda(:,:,1,:))).*conj(img_hybrid_sense));
% mkdir /Volumes/LaCie_Bottom/collaborators/Zhifeng_Chen/Recon_Results_7T_TR50ms_TE25ms/img_buda/buda1
% cd /Volumes/LaCie_Bottom/collaborators/Zhifeng_Chen/Recon_Results_7T_TR50ms_TE25ms/img_buda/buda1


% BUDA 2 RECON

mag = squeeze(abs(img_buda(:,:,2,:)));
ph = angle(squeeze((img_buda(:,:,2,:))).*conj(img_hybrid_sense));
mkdir /Volumes/LaCie_Bottom/collaborators/Zhifeng_Chen/Recon_Results_7T_TR50ms_TE25ms/img_buda/buda2
cd /Volumes/LaCie_Bottom/collaborators/Zhifeng_Chen/Recon_Results_7T_TR50ms_TE25ms/img_buda/buda2


% % POC 1 RECON

% mag = squeeze(abs(img_pocs(:,:,1,:)));
% ph = squeeze(angle(img_pocs(:,:,1,:)));
% mkdir /Volumes/LaCie_Bottom/collaborators/Zhifeng_Chen/Recon_Results_7T_TR50ms_TE25ms/img_pocs/pocs1
% cd /Volumes/LaCie_Bottom/collaborators/Zhifeng_Chen/Recon_Results_7T_TR50ms_TE25ms/img_pocs/pocs1


% % POC 2 RECON

% mag = squeeze(abs(img_pocs(:,:,2,:)));
% ph = squeeze(angle(img_pocs(:,:,2,:)));
% mkdir /Volumes/LaCie_Bottom/collaborators/Zhifeng_Chen/Recon_Results_7T_TR50ms_TE25ms/img_pocs/pocs2
% cd /Volumes/LaCie_Bottom/collaborators/Zhifeng_Chen/Recon_Results_7T_TR50ms_TE25ms/img_pocs/pocs2
